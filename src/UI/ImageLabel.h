...
class ImageLabel : public QLabel {
    Q_OBJECT
public:
    explicit ImageLabel ( unsigned int _sizex = 0,unsigned int _sizey = 0,unsigned int _index = 0,TweetContent *_parent_content = Q_NULLPTR,QWidget *parent = Q_NULLPTR, Qt::WindowFlags f = Qt::WindowFlags() );
